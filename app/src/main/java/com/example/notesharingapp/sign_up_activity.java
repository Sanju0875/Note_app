...
public class sign_up_activity extends AppCompatActivity {
    ...
    private void createAccount(String email, String password) {
        checkIfEmailOrPhoneExists(Email, Phone, exists -> {
            if (exists) {
                Toast.makeText(sign_up_activity.this, "Email or Phone already in use. Please use different one.", Toast.LENGTH_SHORT).show();
            } else {
                ...
                mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(sign_up_activity.this, "Account Creation Failed", Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
